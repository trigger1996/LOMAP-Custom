...
def main():
    ...
    with Timer('TASE 2021 Complex'):
        ...
        ts_tuple = (r1, r2, r3, r4, r5)                             # (r1, r2, r3, r4, r5, r6)
        is_modifible = [True, True, False, False, False]            # [True, True, False, False, False, False]
    ...
    # animations
    view_complex_2.visualize_animation_w_team_run(ts_tuple, team_suffix_cycle)
