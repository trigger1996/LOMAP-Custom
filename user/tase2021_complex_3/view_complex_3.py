...
dot_color_ref = ['ro', 'b*', 'co', 'm*', 'gv', 'gv', 'gv', 'gv', 'gv', 'gv' ]
...
def visualize_run(tran_sys, run, edgelabel='control', draw='matplotlib'):
    ...
    if draw == 'pygraphviz':
        ...
        node_colors['u1'] = node_colors['u2'] = node_colors['u3'] = node_colors['u4'] = 'tomato'
        node_colors['g1'] = node_colors['g2'] = node_colors['g3'] = 'cornflowerblue'
        node_colors['g4'] = node_colors['g5'] = node_colors['g6'] = 'cornflowerblue'
